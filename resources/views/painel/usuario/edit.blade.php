    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="panel ">
                    <div class="panel-heading">
                        <button data-toggle="modal" data-target="#myModal" class="btn btn-success">Adicionar Conta</button>
                        <h3 class="panel-title">Editar Contas Bancarias</h3>
                    </div>
                    <div class="panel-body">
                            ...
                            <tbody>
                                @forelse($user->contas as $conta)
                                    <tr>
                                        ...
                                        <td>{{ $conta->agencia }}</td>
                                        <td>{{ $conta->conta }}</td>
                                        <td><a href="{{ url('admin/delete/conta', $conta->id) }}"
