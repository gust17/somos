            ...
            <div class="col-lg-8">
                <div class="panel ">
                    ...
                    <div class="panel-body text-center">
                        @if (isset($produto->arquivo))
                            <a href="{{ url('arquivos/produtos/doc', $produto->arquivo) }}">Termo</a><br>

                        @else
                        @endif
                        <form method="post" action="{{ url('api/file-upload/produto/doc/upload') }}"
                        ...
                        <a href="{{ url('admin/produtos') }}" class="btn btn-success">Listar Produtos</a>
                        <br />
                        <div class="progress">
